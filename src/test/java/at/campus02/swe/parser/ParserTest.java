...
public class ParserTest {
   ...
   public void testParserModuloTestXml() throws Exception {
        ...
        Parser parser = new Parser(cal);
        parser.parse(new File("src/test/resources/ModuloTest.xml"));
    ...
    @Test
    public void testParserSinTestXml() throws Exception {

        Calculator cal = mock(Calculator.class);

        Parser parser = new Parser(cal);
        parser.parse(new File("src/test/resources/E2ESinusTest01.xml"));
